<?php
session_start(); // debe ir en la primera línea del archivo
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $_SESSION['id']         = mysqli_insert_id($conexion); // opcional, útil para perfil.php
    ...
    <div class="register-container">
        ...
        <form id="registerForm" method="POST" action="">
            ...
            <div class="admin-key-group" id="adminKeyGroup">
                ...
                <div class="error-message" id="adminKeyError">
